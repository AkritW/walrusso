  ...
  return (
    <>
        ...
        <div className="mx-[20px] flex flex-col">
            <label htmlFor="Email" className="text-sm-regular text-gray-600 mb-[6px]">Email</label>
            <input type="email" id="email" placeholder="Enter your email" className="mb-[20px] h-[44px] px-4 w-full border-[1px] border-gray-100 rounded-[8px]"/>
             <label htmlFor="Password" className="text-sm-regular text-gray-600 mb-[6px]">Password</label>
